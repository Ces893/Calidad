...
public class MensajeriasController : Controller
{
    ...
    {
        if (mensajeriaVM == null) { return NotFound(); }
        ...
        if (ModelState.IsValid)
        {
            ...
            TempData[DS.Successfull] = "Mensaje creada correctamente.";
    ...
    public async Task<IActionResult> Edit(int? id)
    {
        ...
        mensajeriaVM.Mensajeria= await _unitWork.Mensajeria.ObtenerAsync(id.GetValueOrDefault());

        if (mensajeriaVM is null) return NotFound();
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        if (mensajeriaDB is null) // Si es nulo muestre un mensaje
